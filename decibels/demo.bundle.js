...
document.querySelector('#start_speak').addEventListener("click", function() {
      var speechrecognitionlist = new SpeechGrammarList();
      speechrecognitionlist.addFromString  ( document.querySelector('#gram').value , 1 );
      recognition.start(_stream);
  });
  ...
  getUserMedia(function(err, stream) {
    if (err) throw err
      ...
      recognition.onresult = function(event) {
          ...
          document.querySelector('#finalresult').innerHTML = final_transcript ;
      };
